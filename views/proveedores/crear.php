...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-plus-circle"></i> Crear Proveedor</h3>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?= BASE_URL ?>index.php?action=proveedores&method=guardar" method="POST" id="formProveedor">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="cedula" id="cedula" required
                                            pattern="\d{7,9}" title="La cédula debe tener 7-8 dígitos para V/E o 8-9 para J">
                                    </div>
                                    <small class="text-muted" id="cedulaHelp">Ingrese 7-8 dígitos para V/E o 8-9 dígitos para J</small>
                                </div>
                            </div>
                            <div class="form-group">
