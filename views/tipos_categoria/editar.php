...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-edit"></i> Editar Tipo de Categoría</h3>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        Editar Información de Tipo de Categoría
                    </header>
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?= BASE_URL ?>index.php?action=tipos-categoria&method=actualizar&id=<?= $tipo['id']; ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="id_estatus" required>
                                        <option value="1" <?= $tipo['id_estatus'] == 1 ? 'selected' : ''; ?>>Activo</option>
                                        <option value="2" <?= $tipo['id_estatus'] == 2 ? 'selected' : ''; ?>>Inactivo</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
