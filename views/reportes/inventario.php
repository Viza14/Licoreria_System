                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-center">
                            <div class="mb-2">
                                Mostrando <?= count($reporte) ?> de <?= $total_registros ?> registros
                            </div>
                            <ul class="pagination justify-content-center">
                                <?php if ($pagina_actual > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="?action=reportes&method=inventario&pagina=<?= $pagina_actual - 1 ?><?= !empty($filtros) ? '&' . http_build_query(['filtros' => $filtros]) : '' ?>">
                                ...
                                <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
                                    <li class="page-item <?= $i === $pagina_actual ? 'active' : '' ?>">
                                        <a class="page-link" href="?action=reportes&method=inventario&pagina=<?= $i ?><?= !empty($filtros) ? '&' . http_build_query(['filtros' => $filtros]) : '' ?>"><?= $i ?></a>
                                    </li>
                                <?php endfor; ?>
