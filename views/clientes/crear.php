            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?= BASE_URL ?>index.php?action=clientes&method=guardar" method="POST" id="formCliente">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="cedula" id="cedula" required
                                            pattern="\d{7,9}" title="La cédula debe tener entre 7 y 9 dígitos según el tipo">
                                    </div>
                                    <small class="text-muted" id="cedulaHelp">Ingrese 7-8 dígitos para V- o E-, 8-9 dígitos para J-</small>
                                </div>
                            </div>
                            <div class="form-group">
