...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-shopping-cart"></i> Registrar Compra</h3>
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-shopping-cart"></i> Registrar Compra</li>
                </ol>
            </div>
        </div>
        <!--breadcrumbs end-->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fecha_compra" name="fecha_compra" 
                                               value="<?= isset($movimiento_editar) && $movimiento_editar && !empty($movimiento_editar['fecha_movimiento']) ? 
                                                       (($timestamp = strtotime($movimiento_editar['fecha_movimiento'])) !== false ? 
                                                        date('Y-m-d', $timestamp) : date('Y-m-d')) : date('Y-m-d') ?>" required>
                                    </div>
                                </div>
                            </div>
...
document.getElementById('formCompra').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        ...
        text: 'Se registrará la compra con los productos especificados.',
        icon: 'question',
        showCancelButton: true,
