...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-link"></i> Crear Relación Producto-Proveedor</h3>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?= BASE_URL ?>index.php?action=producto-proveedor&method=guardar" method="POST" id="formRelacion">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="cedula_proveedor" required>
                                        ...
                                        <?php foreach ($proveedores as $proveedor): ?>
                                            <option value="<?= $proveedor['cedula'] ?>"><?= $proveedor['cedula_completa'] ?> - <?= $proveedor['nombre'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
